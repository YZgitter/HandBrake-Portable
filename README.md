...
Automatic updates are not supported. If you want to update and keep the settings, the simplest way is to get the new version and copy the *storage* folder from the previous version.
